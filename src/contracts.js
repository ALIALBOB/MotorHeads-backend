...
// The 333 Archives (ERC-721, Ethereum mainnet) — https://opensea.io/collection/the-333-archives
// name "The 333 Archives" / symbol ARCH333 / totalSupply 333 (verified on-chain 2026-09-02).
// Powers the Foundry's daily reward bonus: hold N 333s -> +5% each up to +25% weight, checked on
// the holder's Ethereum wallet. Surfaced to the Foundry app as partners.archive333.balance.
export const ARCHIVE_333_CONTRACT = "0x5eb82c9b5ced4c98982633976941d2cc23f4f9b9";

// Partner-collection holder checks surfaced on /v1/auth/holdings, keyed by the flag
// the frontend reads (e.g. `normies`, `ddg`, `archive333`). Each is a generic ERC-721 balanceOf.
export const PARTNER_COLLECTIONS = Object.freeze([
  { key: "normies", contract: NORMIES_CONTRACT },
  { key: "ddg", contract: DDG_CONTRACT },
  { key: "archive333", contract: ARCHIVE_333_CONTRACT }
]);
